                        ...
                        <div class="block-content block-content-full px-lg-5 py-md-5 py-lg-6">
                            ...
                            <div class="mb-2 text-center">
                                <a class="link-fx font-w700 font-size-h1" href="index.html">
                                    <span class="text-dark">Dolci</span><span class="text-primary">Manie</span>
                                </a>
                            ...
                            <!-- For more info and examples you can check out https://github.com/jzaefferer/jquery-validation -->
                                ...
                                <form method="POST" action="{{ route('login') }}" class="js-validation-signin" aria-label="{{ __('Login') }}">
                                    @csrf
                                <div class="form-group">
                                    <input type="text"   id="email" type="email" class="form-control-alt form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required autofocus placeholder="Nome Utente">
                                </div>
                                <div class="form-group">
