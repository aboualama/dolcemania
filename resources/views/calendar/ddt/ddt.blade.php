            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons js-table-checkable">
                ...
                @foreach($orders as $index => $order)
                    <tr>
                        ...
                        <th class="font-w600 text-xinspire-darker text-center" >{{$order->order_date}}</th>
                        <td class="font-w600 text-center" id ="table_recurrent_{{$order->id}}">&euro; {{$order->total_1}}</td>


                        <td class="text-center" style="width: 50px">
                            <div class="btn-group">
                                <a onclick="view('{{$order->id}}')" target="_blank"  data-toggle="modal" data-target="#modal-block-view" >
                                ...
                                <a onclick="show('{{$order->id}}')" target="_blank"  data-toggle="modal" data-target="#modal-block-show" >
                                    <button type="button" class="btn btn-sm btn-primary" data-toggle="tooltip"
