        ...
        <div class="block-content">
            <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons">
                ...
                <tr>
                    ...
                    <th class="text-center">Totale_1</th>
                    <th class="text-center total2">Totale_2</th>
                ...
                @foreach($orders as $index => $order)
                    <tr>
                        ...
                        <td class="font-w600 text-center total2"
                            id="table_recurrent_{{$order->id}}">{{$order->total_2}}</td>
...
@section('js_after')
    ...
    <script>
        ...
        //             $('#recurrent').val(data.recurrent);
        //             $('#quanity_1').val(data.quanity_1);
        //             $('#quanity_2').val(data.quanity_2);
        //             $('#date').val(data.date);
