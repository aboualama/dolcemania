...
@section('content')
    ...
    <div class="block block-rounded block-bordered ">
        <div class="block-header block-header-default"><h3 class="block-title">Fornitore</h3>
                ...
                @foreach($clients as $client)
                    <tr class="tr{{$client->id}}">
                        ...
                        <th class="font-w600 text-xinspire-darker"
                            id="table_company_name_{{$client->id}}">{{$client->company_name}}</th>
                        <th class="font-w600 text-xinspire-darker"
                            id="table_reference_name_{{$client->id}}">{{$client->reference_name}}</th>
                        <th class="font-w600 text-xinspire-darker"
                        ...
                        <td class="text-center" style="width: 50px">
                            <div class="btn-group">
                                <a onclick="edit('{{$client->id}}')" target="_blank" data-toggle="modal"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="block block-themed block-transparent mb-0">
                    ...
                    <div class="block-content block-content-full text-right bg-light">
                        <button type="button" class="btn btn-sm btn-light" data-dismiss="modal">Close</button>
                        <button type="button" onclick="updateOrder()" class="btn btn-sm btn-primary"
