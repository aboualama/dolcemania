...
<div class="form-group form-row">
    <?php $__currentLoopData = $pricelist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if($list->title != 'Default' ): ?>
    <div class="col-3 ">
        <label><?php echo e($list->title); ?>%</label> 
        <input type="number" class="form-control PriceListTitle" id="<?php echo e($list->title); ?>" name="pricelist"> 
    </div>
        <?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</div> 
