        ...
        <div class="block-content">
            <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons">
                ...
                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <th class="font-w600 text-xinspire-darker text-center"><a href="#"><?php echo e($index +1); ?></a></th>
                        <th class="font-w600 text-xinspire-darker text-center" ><?php echo e($order->product_title); ?></th>
                        <td class="font-w600 text-center"><?php echo e($order->totalItems); ?></td>
                        <td class="font-w600 text-center"><?php echo e(intval($order->totalItems / $order->quantity_tin)); ?></td>
                        <td class="font-w600 text-center"><?php echo e($order->totalItems % $order->quantity_tin); ?></td>
